    ...
    <div className="mt-12">
      <div className="card bg-base-100 w-full mx-auto max-w-sm shrink-0 shadow-2xl">
        <div className="card-body">
          <h1 className="text-center text-2xl">Login Your Account</h1>
          {/* error message box */}
            ...
            <fieldset className="fieldset">
              ...
              <div className="mt-5 flex flex-col gap-3 w-full">
                ...
                <button
                  ...
                  className="btn w-8/10 mx-auto bg-white text-black border-[#e5e5e5]"
                >
                  <svg
                ...
                {/* GitHub */}
                <button className="btn w-8/10 mx-auto bg-black text-white border-black">
                  <svg
